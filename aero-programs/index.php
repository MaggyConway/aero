...
$APPLICATION->SetTitle("Программы по аэропортовой деятельности");
?><?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"DETAIL_PROPERTY_CODE" => array("COURSE_TOPICS","COURSE_MODULES","PRICE",""),
		...
		"LIST_PROPERTY_CODE" => array("COURSE_TOPICS","COURSE_MODULES","PRICE",""),
		"MESSAGE_404" => "",
		"META_DESCRIPTION" => "-",
		"META_KEYWORDS" => "-",
		"NEWS_COUNT" => "",
