...
$APPLICATION->SetTitle("Программы для авиационного персонала");
?><?$APPLICATION->IncludeComponent(
	...
	Array(
		...
		"DETAIL_PROPERTY_CODE" => array("PRICE","COURSE_TOPICS","COURSE_MODULES",""),
		...
		"LIST_PROPERTY_CODE" => array("PRICE","COURSE_TOPICS","COURSE_MODULES",""),
		"MESSAGE_404" => "",
		"META_DESCRIPTION" => "-",
		"META_KEYWORDS" => "-",
		"NEWS_COUNT" => "",
